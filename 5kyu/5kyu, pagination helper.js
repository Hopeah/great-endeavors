...
//P - parameters
//Given an array that provides the amount of items AND an integer that provides the amount of items that can fit on a single page

//R - returns
//Return the object that contains various functions
